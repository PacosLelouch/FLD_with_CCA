...
class DeepFashionDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, i):
        ...
        ret = {}
        ret['D_image_name'] = image_name
        ret['D_image_bb_ori'] = image_bb_ori
        ret['D_image_x1'] = image_x1
        ret['D_image_x2'] = image_x2
        ret['D_image_y1'] = image_y1
        ret['D_image_y2'] = image_y2
        ret['D_landmark_pos_ori'] = landmark_pos_ori
        ret['image_ori'] = image_ori
        ret['image'] = image
